pipeline {
    ...
    stages {
        ...
        stage('Cloning Git') {
            steps {
                checkout([$class: 'GitSCM', branches: [[name: '*/main']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'githubcreds', url: 'https://github.com/XI-4568radhakrishna/Fast-api-2.git']]])     
            }
        }
